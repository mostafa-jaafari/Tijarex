...
export default function UploadProductPage() {
    ...
    // --- MODIFIED: category is now an array of strings ---
    const [categories, setCategories] = useState<string[]>([]);
    const [currentCategory, setCurrentCategory] = useState(""); // State for the input field
    ...
    const handleProductSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const productData = {
                ...
                name: title,
                description,
                // --- MODIFIED: Use the categories array ---
                category: categories,
                ...
                currency: "Dh",
                colors: colors.map((c, i) => ({ ...c, selected: i === 0 })),
                sizes,
                isTrend,
        ...
        <section className="w-full p-3">
            <div className="max-w-7xl mx-auto">
                ...
                <form onSubmit={handleProductSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {/* Left Column */}
                    <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 divide-y divide-gray-200">
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            {/* --- MODIFIED: Category Input Section --- */}
                            <div>
                                <label htmlFor="category" className="block text-sm font-medium text-gray-700 mb-1">Categories</label>
                                <div className="flex flex-wrap gap-2 mb-2">
                                    {categories.map((cat, index) => (
                                        <div key={index} className="flex items-center bg-gray-200 text-gray-800 text-sm font-medium pl-2 pr-1 py-1 rounded-full">
                                            {cat}
