...
export const InputStyles = "w-full px-4 py-2.5 bg-white border-b border-neutral-400 ring ring-neutral-200 text-neutral-700 rounded-lg placeholder:text-neutral-400 focus:outline-none focus:ring-purple-400 focus:border-b-2 focus:border-purple-600 transition-all";
